...
describe("Test promise logical operations", () => {
    ...
    it("should handle OR operation.", () => Promise.or([ // Both Resolve non-empty
    ...
    it("should chain OR operations.", () => Promise.resolve("Andy")._or([
        () => Promise.resolve("Sandy"),
    ...
    it("should handle XOR operation.", () => Promise.xor([ // Both Resolve non-empty
        () => Promise.resolve("Andy"),
        () => Promise.resolve("Sandy")
    ]).catch(err => {
    ...
    it("should chain logic operation concat mix.", () => Promise.xor([
        () => Promise.resolve(),
        () => Promise.resolve("Sandy")
    ])._or([
        () => Promise.resolve("Wendy"),
